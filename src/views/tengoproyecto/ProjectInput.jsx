...
const ProjectInput = () => {
  ...
  return (
    ...
    <div style={{height: '100%', width: '100%'}}>
        ...
        <div style={{width:"100%", height:"100%", marginTop: "10vh"}} className="project_input">
            ...
            >
                ...
                {status 
                ?   <ChildModal />
                :   <Button sx={{backgroundColor:"#1CF445", color:"black"}} onClick={handleClose}>
                        Intentar de nuevo
                    </Button>
                }
            ...
            <Grid sx={{justifyContent:"center", alignItems:"center", height:"70%"}} container>
                ...
                >
                    ...
                    <TextField 
                        ...
                        required 
                        name="name" 
                        FormHelperTextProps={<p>Llena este dato</p>} 
                        onChange={handleChange} 
                        label={getText('proyecto', 'input', 'name')}
                        sx={{
                    ...
                    <TextField 
                        ...
                        name="phone" 
                        onChange={handleChange} 
                        label={getText('proyecto', 'input', 'phone')}
                        sx={{
                            width: isMobile ? "90%" : "40%", 
                            backgroundColor:"white", 
                            borderRadius:"0",
                    ...
                    <TextField 
                        ...
                        name="msg" 
                        onChange={handleChange} 
                        label={getText('proyecto', 'input', 'message')}
                        sx={{
                            width: isMobile ? "90%" : "40%", 
                            backgroundColor:"white", 
                            borderRadius:"0",
